...
<div class="row">
    <div class="col-md-4">
        <form asp-action="Create">
            ...
            <div class="form-group">
                <label asp-for="RentLocation" class="control-label"></label>
                <input asp-for="RentLocation" class="form-control" />
                <span asp-validation-for="RentLocation" class="text-danger"></span>
            </div>
            <div class="form-group form-check">
                <label class="form-check-label">
                    <input class="form-check-input" asp-for="HasDriver" /> @Html.DisplayNameFor(model => model.HasDriver)
                </label>
            </div>
            <div class="form-group">
            ...
            <div class="form-group form-check">
                <label class="form-check-label">
                    <input class="form-check-input" asp-for="Gear" /> @Html.DisplayNameFor(model => model.Gear)
                </label>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label asp-for="FuelConsumed" class="control-label"></label>
                <input asp-for="FuelConsumed" class="form-control" />
                <span asp-validation-for="FuelConsumed" class="text-danger"></span>
            </div>
            <div class="form-group">
                <label asp-for="RideNumber" class="control-label"></label>
                <input asp-for="RideNumber" class="form-control" />
                <span asp-validation-for="RideNumber" class="text-danger"></span>
            </div>
            <div class="form-group">
                <label asp-for="AvgRating" class="control-label"></label>
                <input asp-for="AvgRating" class="form-control" />
                <span asp-validation-for="AvgRating" class="text-danger"></span>
            </div>
            <div class="form-group form-check">
                <label class="form-check-label">
            ...
            <div class="form-group form-check">
                <label class="form-check-label">
                    <input class="form-check-input" asp-for="IsDisabled" /> @Html.DisplayNameFor(model => model.IsDisabled)
                </label>
            </div>
            <div class="form-group">
